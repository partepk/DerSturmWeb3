    ...
    const generalDefaults = Object.create(null, {
      ...
      dontHyphenate: setProp(
        (function createList() {
          const r = empty();
          const list =
            "video,audio,script,code,pre,img,br,samp,kbd,var,abbr,acronym,sub,sup,button,option,label,textarea,input,math,svg,style";
  ...
  (function H9Y() {
      ...
      el.addEventListener(
        ...
        function oncopy(e) {
          ...
          e.clipboardData.setData(
            "text/plain",
            selectedText.replace(new RegExp(SOFTHYPHEN, "g"), "")
          );
        },
        true
      );
      ...
      function processElements(el, pLang, cn, isChild) {
        ...
        while (n) {
          if (
            ...
            if (
              sortOutSubclasses(n.className.split(" "), C.classNames).length ===
              0
            ) {
    ...
    function createOrphanController(cn) {
      ...
      function controlOrphans(
        ...
        return (
          leadingWhiteSpace +
          lastWord.replace(new RegExp(h, "g"), "") +
          trailingWhiteSpace
        );
      }
    ...
    function hyphenateElement(lang, elo) {
      ...
      const normalize = C.normalize && Boolean(String.prototype.normalize);
    ...
    function prepareLanguagesObj(
      ...
      if (!lo.engineReady) {
        ...
        C.classNames.forEach(function eachClassName(cn) {
          ...
          lo.genRegExps[cn] = new RegExp(
            `[\\w${alphabet}${String.fromCharCode(8204)}-]{${
              classSettings.minWordLength
            },}`,
            "gi"
          );
        });
    ...
    function calculateBaseData(hpbBuf) {
      ...
      return {
        heapSize: Math.max(
          calculateHeapSize(wordOffset + 576 + hpbMetaData[2] + hpbMetaData[3]),
          32 * 1024 * 64
        ),
